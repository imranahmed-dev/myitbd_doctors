...
//Corona Test
Route::post('/coronainfo/store','frontend\CoronaTestController@store')->name('coronainfo.store');
Route::get('/corona/result','frontend\CoronaTestController@result')->name('corona.result');
...
Route::group([ 'prefix' => '/users/admins','namespace' => 'backend'], function() {

   Route::get('view','AdminController@index')->name('admin.user.index');
   ...
   Route::post('update/{id}','AdminController@update')->name('admin.user.update');
   Route::get('destroy/{id}','AdminController@destroy')->name('admin.user.destroy');
    
});


Route::group([ 'prefix' => '/users/doctors','namespace' => 'backend'], function() {

   Route::get('view','DoctorController@index')->name('doctor.user.index');
   Route::get('create','DoctorController@create')->name('doctor.user.create');
   Route::post('store','DoctorController@store')->name('doctor.user.store');
   Route::get('edit/{id}','AdminController@edit')->name('doctor.user.edit');
   Route::post('update/{id}','DoctorController@update')->name('doctor.user.update');
   Route::get('destroy/{id}','DoctorController@destroy')->name('doctor.user.destroy');
    
});


Route::group([ 'prefix' => '/users/patients','namespace' => 'backend'], function() {

   Route::get('view','PatientController@index')->name('patient.user.index');
   Route::get('create','PatientController@create')->name('patient.user.create');
   Route::post('store','PatientController@store')->name('patient.user.store');
   Route::get('edit/{id}','PatientController@edit')->name('patient.user.edit');
   Route::post('update/{id}','PatientController@update')->name('patient.user.update');
   Route::get('destroy/{id}','PatientController@destroy')->name('patient.user.destroy');
    
});


Route::group([ 'prefix' => '/doctors/chambers','namespace' => 'backend'], function() {

   Route::get('view','ChamberController@index')->name('doctor.chamber.index');
   Route::get('create','ChamberController@create')->name('doctor.chamber.create');
   Route::post('store','ChamberController@store')->name('doctor.chamber.store');
   Route::get('edit/{id}','ChamberController@edit')->name('doctor.chamber.edit');
   Route::post('update/{id}','ChamberController@update')->name('doctor.chamber.update');
   Route::get('destroy/{id}','ChamberController@destroy')->name('doctor.chamber.destroy');
    
});



Route::group([ 'prefix' => '/doctors/compounders/','namespace' => 'backend'], function() {

   Route::get('view','CompounderController@index')->name('compounder.chamber.index');
   Route::get('create','CompounderController@create')->name('compounder.chamber.create');
   Route::post('store','CompounderController@store')->name('compounder.chamber.store');
   Route::get('edit/{id}','CompounderController@edit')->name('compounder.chamber.edit');
   Route::post('update/{id}','CompounderController@update')->name('compounder.chamber.update');
   Route::get('destroy/{id}','CompounderController@destroy')->name('compounder.chamber.destroy');
    
});



Route::group([ 'prefix' => '/contacts/','namespace' => 'backend'], function() {

   Route::get('view','ContactController@index')->name('admin.contact.index');
