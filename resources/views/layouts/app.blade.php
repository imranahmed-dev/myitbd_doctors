                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class=" ">
                                            <a href="{{ route('doctor.user.index') }}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                        ...
                                        <li class=" ">
                                            <a href="{{ route('doctor.chamber.index') }}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Doctors Chambers</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li> 

                                        <li class=" ">
                                            <a href="{{ route('compounder.chamber.index') }}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Compounders</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>

                                        <li class=" ">
                                            <a href="{{ route('patient.user.index') }}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
