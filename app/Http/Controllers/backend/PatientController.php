...
class PatientController extends Controller
{
    ...
    {
        $data['users'] = User::where('role',2)->where('usertype',2)->get();
        return view('backend.users.patients.view',$data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect()->route('patient.user.index')->with($notification);
        }
    }
